sap.ui.define([
	...
	return BaseController.extend("com.evonik.appsDocumentManager.controller.App", {
		...
		onListUpdateFinished: function(){
			var oFileUploadControl = sap.ui.getCore().byId("fileUploader");
			oFileUploadControl.setUploadUrl("/docservice/DocumentManager/DirectoryList/" + this.getRepositoryName());                        
		},
