sap.ui.define([
	...
	return BaseController.extend("com.evonik.appsDocumentManager.controller.App", {
		onInit: function(){
			this.getModel().loadData("/docservice/DocumentManager/DirectoryList/" + this.getRepositoryName());
		},
		onExit: function() {
		...
		onListUpdateFinished: function(){
			this.getModel("appDataModel").setProperty("/repositoryName", this.getRepositoryName());	
		},
